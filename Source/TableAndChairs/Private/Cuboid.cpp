...
void Cuboid::generate()
{
    ...
    m_Mesh->SetMaterial(Nsections, Material.Object.Get());

    m_Mesh->CreateMeshSection_LinearColor(Nsections++, m_Vertexes, m_Triangles, m_Normals, m_UVs, TArray<FLinearColor>(), m_Tangents, true);
}
